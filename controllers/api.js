const ComponentManager = require('../modules/component-manager')();
...
function register_component($) {
    try {
        const result = ComponentManager.register($.body);
        $.success(result);
    } catch (error) {
        console.error('Component registration error:', error.message);
        $.invalid(500, error.message);
    }
}
